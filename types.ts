...
export interface GameObject {
  ...
  doubleJumped?: boolean; // For double jump state
  isFalling?: boolean; // For falling state
  oscillation?: {
    axis: 'x' | 'y';
    distance: number;
    speed: number;
